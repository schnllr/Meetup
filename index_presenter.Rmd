...
I believe in the persuasion of the force of convenience will get more and more people to use our color scheme.
...
### Content
.pull-left[
```{r, eval = T, echo = T, tidy=T, tidy.opts=list(blank=FALSE, width.cutoff=30)}
library(statRmd)
